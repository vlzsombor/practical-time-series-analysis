...
$$
\mu = \frac{1}{3} \mu + \frac{1}{2} \mu \implies \mu=0
$$
...
$$
E[X_t E_{t-k}] = \frac{1}{3} E[X_{t-1}X_{t-k}] + \frac{1}{2} E[X_{t-2} X_{t-k}] + E[Z_t X_{t-k}]
$$

#### 4- Express in terms of covariance function

Assuming there is no covariance contribution between $Z_t$ and $X_t$ (i.e. $E[X_{t-k} Z_t] = 0$) ad knowing that:
...
$$
... \\
p(5) = \frac{1}{3} p(4) + \frac{1}{2} p(3) \\
p(6) = \frac{1}{3} p(5) + \frac{1}{2} p(4) \\
... \\
p(k) = \frac{1}{3} p(k-1) + \frac{1}{2} p(k-2) \\
$$

#### 6- Solve Yule-Walker equation

As done previously on this document, we must solve a difference equation. We use replacement $\rho(k) = a_n$, then:
